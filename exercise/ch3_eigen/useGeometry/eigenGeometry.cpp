...
// demonstrate using Eigen geometry

int main(int argc, char **argv) {
    // Eigen/Geometry provides seveal rotation and transitions
    // 3D rotation matrix can directly use Matrix3d or Matrix3f
    Matrix3d rotation_matrix = Matrix3d::Identity();
    AngleAxisd rotation_vector(M_PI / 4, Vector3d(0, 0, 1)); // roatate 45 degress along z axis
    cout.precision(3);
    cout << "roatation matrix = \n" << rotation_vector.matrix() << endl; 
